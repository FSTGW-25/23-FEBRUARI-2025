...
<body>
  <div class="title-box">22 Hari Lagi Kak Thania Theresia Podung Ulang Tahun! 🎉🎂🥳</div>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 7.jpeg" class="gallery-photo">
    </div>
  </div>

  <script>
    const audio = new Audio('Seventeen-Cheers.mp3');
    ...
    const fullMessage = `Hidup adalah tentang terus maju dan merayakan setiap langkah, sekecil apa pun itu 🌈. Tak perlu menunggu segalanya sempurna untuk bersyukur—hari ini sendiri sudah cukup untuk dirayakan 🌼. Nikmati setiap momen, karena setiap detik berharga dalam perjalanan ini 🌻. Ada tantangan, ada lelah, tapi jangan biarkan itu menghentikan semangatmu. Bangkit, tersenyum, dan terus melangkah, karena perjalanan ini adalah milikmu untuk dinikmati sepenuhnya 🌸🤍.`;
